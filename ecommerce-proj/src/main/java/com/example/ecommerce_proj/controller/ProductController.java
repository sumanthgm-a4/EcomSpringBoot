...
import com.example.ecommerce_proj.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<Product> getProductById(@PathVariable("id") int prod_id) {
    ...
    public ResponseEntity<?> addProduct(@RequestPart Product product, @RequestPart MultipartFile imageFile) {
        ...
        try {
            savedProd = productService.addOrUpdateProduct(product, imageFile);
